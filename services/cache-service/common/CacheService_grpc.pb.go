...
type CacheServiceClient interface {
	Set(ctx context.Context, in *SetKeyValueReq, opts ...grpc.CallOption) (*empty.Empty, error)
	Get(ctx context.Context, in *GetKeyReq, opts ...grpc.CallOption) (*GetValueReq, error)
	Delete(ctx context.Context, in *GetKeyReq, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *cacheServiceClient) Set(ctx context.Context, in *SetKeyValueReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *cacheServiceClient) Get(ctx context.Context, in *GetKeyReq, opts ...grpc.CallOption) (*GetValueReq, error) {
	out := new(GetValueReq)
...
func (c *cacheServiceClient) Delete(ctx context.Context, in *GetKeyReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type CacheServiceServer interface {
	Set(context.Context, *SetKeyValueReq) (*empty.Empty, error)
	Get(context.Context, *GetKeyReq) (*GetValueReq, error)
	Delete(context.Context, *GetKeyReq) (*empty.Empty, error)
...
func (UnimplementedCacheServiceServer) Set(context.Context, *SetKeyValueReq) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Set not implemented")
}
func (UnimplementedCacheServiceServer) Get(context.Context, *GetKeyReq) (*GetValueReq, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Get not implemented")
}
func (UnimplementedCacheServiceServer) Delete(context.Context, *GetKeyReq) (*empty.Empty, error) {
...
func _CacheService_Set_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CacheServiceServer).Set(ctx, req.(*SetKeyValueReq))
	}
...
func _CacheService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CacheServiceServer).Get(ctx, req.(*GetKeyReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CacheService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CacheServiceServer).Delete(ctx, req.(*GetKeyReq))
	}
	return interceptor(ctx, in, info, handler)
}
